...
const Login = () => {
    ...
    useEffect(() => {
        document.title = "Login - Get Me A Stork"
        if (session) {
        ...
        <>
            <div className="min-h-[calc(100vh-5.5rem-4rem)]">
                <div className='py-14 container mx-auto '>
                    <h2 className="mb-4 text-2xl text-center font-bold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Sign<mark className="px-2 text-white bg-blue-600 rounded-sm dark:bg-blue-500">In</mark> or Sign<mark className="px-2 text-white bg-blue-600 rounded-sm dark:bg-blue-500">Up</mark></h2>
                </div>

                <div className="container mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 flex flex-col gap-2 w-fit mb-42">
                    <button
